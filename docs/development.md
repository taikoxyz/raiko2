...
generated from a real preflight.
...
`scripts/regression/stress_proposal.py --discover-only --proposal-out` to capture the full
...
The file-based proposal regression flow lives in
