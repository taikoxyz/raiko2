![Raiko2 — Taiko proposal proof orchestration](docs/assets/readme-banner.png)
...
Raiko2 is a proposal proof service for Taiko, currently proving the Unzen fork. It builds
canonical guest inputs from RPC data,
...
- Single proposal pipeline for preflight, validation, proving, and aggregation
