...
const DEFAULT_RPC_URL_HOODI_SHASTA: &str = "https://rpc.hoodi.taiko.xyz";
...
const MAINNET_NETWORK: &str = "mainnet";
...
mod tests {
    ...
    fn mainnet_profile_rejects_wrong_chain_id() {
        ...
        assert!(err.to_string().contains("expects mainnet chain id"));
    }
