...
mod tests {
    ...
    fn rpc_pair_beacon_rpc_overrides_l1_chain_spec() {
        let beacon_rpc = "https://l1beacon.internal.taiko.xyz/".to_string();
        let config = RpcConfig {
            pairs: vec![NetworkPairConfig {
                network: "taiko_dev".to_string(),
                l1_network: "taiko_dev_l1".to_string(),
                l1_rpc: Some("https://l1rpc.internal.taiko.xyz/".to_string()),
                beacon_rpc: Some(beacon_rpc.clone()),
                l2_rpc: Some("https://rpc.internal.taiko.xyz/".to_string()),
        ...
        assert_eq!(pair.beacon_rpc.as_deref(), Some(beacon_rpc.as_str()));
        assert_eq!(
