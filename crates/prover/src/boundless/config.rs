...
pub fn validate_offer_spec(offer_spec: &BoundlessOfferParams) -> Result<(), String> {
    match offer_spec.pricing_mode {
        BoundlessPricingMode::Manual => validate_manual_prices(offer_spec)?,
        BoundlessPricingMode::Market => validate_market_prices(offer_spec)?,
    }
...
fn validate_manual_prices(offer_spec: &BoundlessOfferParams) -> Result<(), String> {
...
fn validate_market_prices(offer_spec: &BoundlessOfferParams) -> Result<(), String> {
