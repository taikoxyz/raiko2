...
- `rpc.pairs[*].l1_genesis_time` and `rpc.pairs[*].l1_seconds_per_slot` optionally override
  the built-in L1 beacon timing used to map Shasta blob timestamps to beacon slots.
