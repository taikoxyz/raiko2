...
mod test {
    ...
    use alloy_primitives::{Uint, address, hex};
    ...
    // NOTE: These tests are commented out because they depend on types not yet defined in this crate.
    // Uncomment once ProofCarryData, TransitionInputData, and ShastaTransitionInput are available.

    // #[test]
    // fn test_hash_shasta_transition_input_binds_continuity_fields() {
    //     use crate::shasta::Checkpoint;
