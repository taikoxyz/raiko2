...
mod tests {
    use super::{
        ...
        ElfType, JsonRpcError, JsonRpcResponse, MIN_REBID_TIMEOUT_MS, TimeoutPolicy,
        boundless_poll_error_statuses, classify_boundless_status, escalate_and_cap_market_prices,
    ...
    fn final_attempt_falls_back_to_rebid_delay_without_lock_deadline() {
        ...
        assert_eq!(no_lock_deadline(1_000, 0, timeout), 1_300);
    }
