...
use raiko2_pipeline::{PipelineSpec, ProofStage, ProverBackend, Risc0Backend};
...
impl<S> crate::Prover<S, Risc0Backend> for Risc0Prover
where
    S: PipelineSpec<Risc0Backend>,
    Risc0Backend: ProverBackend<S>,
{
    async fn prove(
        &self,
        input: GuestInput,
